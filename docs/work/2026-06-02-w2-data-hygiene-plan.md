...
### 065 — Jerarquía de ubicación (Provincia/Distrito/Corregimiento) · **DIFERIDO (baja urgencia + vocab Samantha)**
...
4. Confirmar que **065 + V-2/V-3/V-4 quedan diferidos/gated** (no se tocan ahora).
