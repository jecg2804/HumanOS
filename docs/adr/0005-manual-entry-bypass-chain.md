...
> Related: la decisión de **schema** (columnas + foto en files.uploads) vive en `0021-manual-entry-schema-files-uploads.md` (Chat-level ADR-0012, merged 2026-06-01). Este ADR cubre el **comportamiento**.
