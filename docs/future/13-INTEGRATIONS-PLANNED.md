# 13-INTEGRATIONS-PLANNED.md — Integraciones ETL / master data (planned)

**Role:** catálogo de sistemas externos planned/ETL (no Live aún) + apps futuras ICONSA. · **Read-when:** al diseñar una integration ETL nueva o planificar una mini-app. · **Maintain-when:** una integration arranca/cambia status, o se planifica una nueva app.
