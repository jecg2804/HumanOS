...
| **W1** | BD schema-first — `docs/work/db-final-vision-design.md`. Aprobado por James batch-por-batch. | **DONE** (054-062: foundation + vistas + mdm DOMAIN + pgvector + audit lineage + SEC-CONSENT; MIG-DRIFT + TYPES-STALE; gate verde) |
